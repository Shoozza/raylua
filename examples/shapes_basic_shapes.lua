...
while not rl.WindowShouldClose() do
  ...
  rl.DrawTriangle(rl.Vector2(screenWidth / 4 * 3, 80),
                  rl.Vector2(screenWidth / 4 * 3 - 60, 150),
                  rl.Vector2(screenWidth / 4 * 3 + 60, 150), rl.VIOLET)
    
  rl.DrawPoly(rl.Vector2(screenWidth / 4 * 3, 320), 6, 80, 0, rl.BROWN)
  ...
  rl.DrawTriangleLines(rl.Vector2(screenWidth / 4 * 3, 160),
                       rl.Vector2(screenWidth / 4 * 3 - 20, 230),
                       rl.Vector2(screenWidth / 4 * 3 + 20, 230), rl.DARKBLUE)
  rl.EndDrawing()
end
